            ...
            <div class="role_view_section">
                ...
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">User's All Post</h4>
                    </div>
                            ...
                            <table id="data-table" class="table table-striped table-bordered nowrap" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ date('jS F Y, g:i A',strtotime($data->created_at)) }}</td>
                                        <td>
                                    ...
                                    @endif    
                                            ...
                                            <div class="modal fade passwordModal" id="status{{$data->_id}}">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        {!! Form::open(array('url' => "user-post-access/$data->_id/0",'class'=>'form-horizontal author_form','method'=>'POST','files'=>'true')) !!}
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('user-post-admin.show',$data->_id) }}" class="btn btn-success btn-sm m-r-5 m-b-5" target="_blank"> View </a>
                                            
                                            <!-- end user edit section -->
                                            <!-- start user delete section -->
                                            <a <?php if ($adminId != $superID): ?>disabled<?php endif ?> href="#delete{{$data->_id}}"  class="btn btn-danger btn-sm m-r-5 m-b-5" data-toggle="modal">Delete</a>
                                            ...
                                            <div class="modal fade passwordModal" id="delete{{$data->_id}}">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        {!! Form::open(array('url' => "user-post-access/$data->_id/1",'class'=>'form-horizontal author_form','method'=>'POST','files'=>'true')) !!}
                                                        <div class="modal-body">
