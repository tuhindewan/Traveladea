				...
				<div class="col-md-12">
					<div class="row">
						...
						<div class="col-md-offset-1 col-md-4 home_top_panel no_padding">
							...
							<textarea name="newsfeed" class="form-control home_set_box_panel" id="" rows="5" placeholder="What's on your mind?"></textarea>
							<div class="home_post_overlay"></div>
							<button class="show-dialog"> Show Dialog </button>
							<div class="post-dialog"> 
								<textarea name="" class="form-control" id="" cols="30" rows="10"></textarea> <br/>
