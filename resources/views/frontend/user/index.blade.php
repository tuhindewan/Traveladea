	 			  ...
	 			  <div class="col-md-12">
	 			    <div class="cover profile">
	 			      <div class="wrapper">
	 			        <div class="image">
	 			          <div class="cover-image picture-container" style="width: 788px;height: 300px;overflow: hidden; position: relative;">
	 			          	...
	 			          	@else
	 			          	<a href="">
	 			          		<img style="position: absolute;" height="350px" width="788px;" id="blah" class="headerimage ui-corner-all" src='public/frontend/images/Cover/blank-cover-template-1.jpg' alt="photo">
	 			          	</a>
	 			          	@endif
	 			          		<!-- <div class="overlay overlay-dark"></div> -->
	 			          		<div class="dropdown cover-add-icon">
									<button class="btn btn-update-cover dropdown-toggle" type="button" data-toggle="dropdown"><i class="fa fa-camera-retro" aria-hidden="true"></i> Update Cover Photo</button>
									<ul class="dropdown-menu update-btn-dropdown">
										<li><a href="#">Select Photo</a></li>
										<li>
											{!! Form::open(array('route' => 'coverimage.store','id'=>'coverimageform','method'=>'POST','files'=>'true')) !!} 
						                		{!! csrf_field() !!}
												<div class="file-upload">
													<label for="upload-1" id="upload-cover" class="btn" style="font-size: 12px;">Upload Photo</label>
													<input type="file" name="coverimage" onchange="readURL(this);" id="upload-1">
												</div>
											{!! Form::close(); !!}
										</li>
										<li><a href="#">Remove</a></li>
										<li><a href="" class="pos">Reposition</a></li>
										<div class="home_submenu_overlay"></div>
  									</ul>
	 			          		</div>
	 			          		<input type="button" onclick="submitForm()" class="btn btn-xs btn-save-cover" value="Save Cover" name="">
	 			          		<a href=""><button class="btn btn-xs btn-cancel-cover" style="">Cancel</button></a>
	 			          		<button class="btn btn-xs btn-position-cover"><a href="" class="save">Save Position</a></button>
	 			          </div>
	 			        </div>
	 			        <ul class="friends">
	 			          <li>
	 			      ...
	 			      <div class="cover-info">
	 			        ...
	 			        <div class="name"><a href="{{URL::to('/profile')}}">{{$user_info['firstname']}} {{$user_info['middlename']}} {{$user_info['lastname']}}</a></div>
	 			        <ul class="cover-nav">
