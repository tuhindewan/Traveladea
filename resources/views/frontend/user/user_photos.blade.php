				...
				<div class="tab-content photo-tab-content">
					<div class="tab-pane" id="photo-page" role="tabpanel">
						...
						<div class="photo-album-wrapper">
							...
							<div class="photo-item single-photo-item col-4-width">
								<img  src="public/frontend/img/photo-item3.jpg" alt="photo">
								<div class="single-photo-overlay overlay-dark"></div>
								<a href="#" class="more"><i style="font-size: 20px;" class="fa fa-ellipsis-h dropdown-toggle" data-toggle="dropdown" aria-hidden="true"></i></a>
								<a href="#" class="post-add-icon inline-items">
									<i class="fa fa-heart-o" style="font-size: 22px;color: #fff;" aria-hidden="true"></i>
							...
							<div class="photo-item single-photo-item col-4-width">
								<img  src="public/frontend/img/photo-item4.jpg" alt="photo">
								<div class="single-photo-overlay overlay-dark"></div>
								<a href="#" class="more"><i style="font-size: 20px;" class="fa fa-ellipsis-h dropdown-toggle" data-toggle="dropdown" aria-hidden="true"></i></a>
								<a href="#" class="post-add-icon inline-items">
									<i class="fa fa-heart-o" style="font-size: 22px;color: #fff;" aria-hidden="true"></i>
							...
							<div class="photo-item single-photo-item col-4-width">
								<img  src="public/frontend/img/photo-item5.jpg" alt="photo">
								<div class="single-photo-overlay overlay-dark"></div>
								<a href="#" class="more"><i style="font-size: 20px;" class="fa fa-ellipsis-h dropdown-toggle" data-toggle="dropdown" aria-hidden="true"></i></a>
								<a href="#" class="post-add-icon inline-items">
									<i class="fa fa-heart-o" style="font-size: 22px;color: #fff;" aria-hidden="true"></i>
							...
							<div class="photo-item single-photo-item col-4-width">
								<img  src="public/frontend/img/photo-item7.jpg" alt="photo">
								<div class="single-photo-overlay overlay-dark"></div>
								<a href="#" class="more"><i style="font-size: 20px;" class="fa fa-ellipsis-h dropdown-toggle" data-toggle="dropdown" aria-hidden="true"></i></a>
								<a href="#" class="post-add-icon inline-items">
									<i class="fa fa-heart-o" style="font-size: 22px;color: #fff;" aria-hidden="true"></i>
							...
							<div class="photo-item single-photo-item col-4-width">
								<img  src="public/frontend/img/photo-item8.jpg" alt="photo">
								<div class="single-photo-overlay overlay-dark"></div>
								<a href="#" class="more"><i style="font-size: 20px;" class="fa fa-ellipsis-h dropdown-toggle" data-toggle="dropdown" aria-hidden="true"></i></a>
								<a href="#" class="post-add-icon inline-items">
									<i class="fa fa-heart-o" style="font-size: 22px;color: #fff;" aria-hidden="true"></i>
							...
							<div class="photo-item single-photo-item col-4-width">
								<img  src="public/frontend/img/photo-item9.jpg" alt="photo">
								<div class=" single-photo-overlay overlay-dark"></div>
								<a href="#" class="more"><i style="font-size: 20px;" class="fa fa-ellipsis-h dropdown-toggle" data-toggle="dropdown" aria-hidden="true"></i></a>
								<a href="#" class="post-add-icon inline-items">
									<i class="fa fa-heart-o" style="font-size: 22px;color: #fff;" aria-hidden="true"></i>
							...
							<div class="photo-item single-photo-item col-4-width">
								<img  src="public/frontend/img/photo-item10.jpg" alt="photo">
								<div class="single-photo-overlay overlay-dark"></div>
								<a href="#" class="more"><i style="font-size: 20px;" class="fa fa-ellipsis-h dropdown-toggle" data-toggle="dropdown" aria-hidden="true"></i></a>
								<a href="#" class="post-add-icon inline-items">
									<i class="fa fa-heart-o" style="font-size: 22px;color: #fff;" aria-hidden="true"></i>
							...
							<div class="photo-item single-photo-item col-4-width">
								<img  src="public/frontend/img/photo-item11.jpg" alt="photo">
								<div class="single-photo-overlay overlay-dark"></div>
								<a href="#" class="more"><i style="font-size: 20px;" class="fa fa-ellipsis-h dropdown-toggle" data-toggle="dropdown" aria-hidden="true"></i></a>
								<a href="#" class="post-add-icon inline-items">
									<i class="fa fa-heart-o" style="font-size: 22px;color: #fff;" aria-hidden="true"></i>
				...
				<div class="swiper-wrapper">
					...
					<div class="swiper-slide">
						<div class="open-photo-item">
							<img src="public/frontend/img/open-photo1.jpg" alt="photo">
						</div>
					</div>
