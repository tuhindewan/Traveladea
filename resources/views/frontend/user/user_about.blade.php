...
.about-window-popup .olymp-computer-icon {
    width: 22px;
    height: 20px;
}
					    				...
					    				<div class="col-md-6">
					    					<div class="basic-info">
					    					  ...
					    					  <p class="data-row">
					    					    ...
					    					    <span class="data-value">Oct 6, 1993</span>
					    					  </p>
					    					  <p class="data-row">
...
<div class="modal fade" id="update-header-photo">
	...
	<div class="modal-dialog about-ui-block about-window-popup about-update-header-photo">
		...
		<div class="about-ui-block-title photo-modal-about-ui-block-title">
			<h6 class="title photo-modal-title" id="about-modal-title" >Add Place Where You Want to Visit</h6>
		</div>
				...
				<div class="form-group">
					...
					<div class="cols-sm-10">
						<div class="input-group">
							...
							<input type="text" class="form-control about-form-control" name="name" id="name"  placeholder="Enter Location Name"/>
						</div>
					</div>
				</div>
				<div class="form-group">
