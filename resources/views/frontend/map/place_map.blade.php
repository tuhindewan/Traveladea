...
@endpush
	...
	<div>
		<a href="#plans" role="tab" data-toggle="tab"><img class="plan-image" src="{{asset('public/frontend/img/plans.png')}}" alt=""></a>
		<a class="semi-transparent-button active" href="#plans" role="tab" data-toggle="tab">Plans</a>
	</div>
	<div>
		<a href="#experiences" role="tab" data-toggle="tab"><img class="experiences-image" src="{{asset('public/frontend/img/experiences.png')}}" alt=""></a>
		<a class="experiences-transparent-button" href="#experiences" role="tab" data-toggle="tab">Experiences</a>
	</div>
	<div>
		<a href="#suggestions" role="tab" data-toggle="tab"><img class="suggestions-image" src="{{asset('public/frontend/img/suggestions.png')}}" alt=""></a>
		<a class="suggestions-transparent-button" href="#suggestions" role="tab" data-toggle="tab">Suggestions</a>
	</div>
	
	<div>
		<a href="#questions" role="tab" data-toggle="tab"><img class="questions-image" src="{{asset('public/frontend/img/questions.png')}}" alt=""></a>
